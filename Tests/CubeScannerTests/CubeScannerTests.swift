...
final class StickerColorClassifierTests: XCTestCase {
    ...
    func testClassifierDefaultConfiguration() async {
        ...
        XCTAssertEqual(whiteSatThreshold, 0.15, accuracy: 0.01, "Default white saturation threshold")
        
        let whiteBriThreshold = await classifier.whiteBrightnessThreshold
        XCTAssertEqual(whiteBriThreshold, 0.55, accuracy: 0.01, "Default white brightness threshold")
    }
